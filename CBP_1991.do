...
* David Dorn, May 15, 2009
* Update September 27, 2010: Keep AK, HI

* Input file: CBP_1990.dta
* Output file: CBP_1990adj.dta

* This file closely follows the imputations from cbp1980_imputations.do
* for 1980.
cls
clear	
capture cd "/Users/annievm3m4vup/Dropbox/2022Fifthyearpaper/Data/Raw/County Business Pattern"
set more off, permanently
capture log close
*******************************************************************
import delimited "./raw/cbp91co.txt", clear 
rename fipstate fipstate2
rename fipscty fipscty2
rename sic siccode2
rename empflag tflag
rename emp tempmm
rename qp1 tpayq1
rename ap tanpay
rename est testab
...
rename censtate state2
rename cencty county2

save "./dta/CBP_1991.dta", replace

*******************************************************************
* Administrative Commands
*******************************************************************

use "./dta/CBP_1991.dta", clear
...
* industries.
* - Add 2-4-digit observations (code 9999) for code1==0 (missing industries)
...
save cbp1991temp.dta, replace

use cbp1991temp.dta, clear
...
save "./dta/CBP_1991adj.dta", replace

erase cbp1991temp.dta
